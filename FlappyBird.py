...
IMAGEM_DO_CANO = pygame.transform.scale2x(pygame.image.load(os.path.join('img', 'pipe.png')))
IMAGEM_DO_CHAO = pygame.transform.scale2x(pygame.image.load(os.path.join('img', 'base.png')))
IMAGEM_DO_BACKGROUD = pygame.transform.scale2x(pygame.image.load(os.path.join('img', 'bg.png')))
IMAGEM_DO_PASSARO = [
...
def desenhar_tela(tela, passaros, canos, chao, pontos):
    ...
    tela.blit(IMAGEM_DO_BACKGROUD, (0, 0))
...
def main():
    ...
    rodando = True
    while rodando:
        relogio.tick(30) # como se fosse o FPS
